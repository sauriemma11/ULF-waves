...
parser.add_argument('--timespan',
                    ...
                    help="""Number of hours over which to find average Tau, PSD, and DLL values.
...
parser.add_argument('--freq_band',
                    ...
                    help="""Values to define the frequency band of interest.
                      First element is lower frequency, and second element is upper frequency [Hz].""",
                    required=False)
