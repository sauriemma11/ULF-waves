...
def background_sub(b_in):
    ...
    b,a = butter_filter(fs ,fc,N, btype)
    b_x = apply_butter(b_in[:][:,0],b,a) #applying highpass filter subtracts the background field(lower freq)
    b_y = apply_butter(b_in[:][:,1],b,a) #same as subtracting the low pass filter
...
def get_bav_bsub(bfile,date):
    ...
    g_epn = np.where((g_epn!=-9.999e+03),g_epn,np.nan) #should work for nx3 
    ...
    for n in np.arange(len(g_epn)): 
        ...
        e_phi2 = e_par2 * [-1,0,0] #e_phi = -1 points radially away from earth 
        e_phi3 = e_phi2 / np.linalg.norm(e_phi2) 
        e_r = e_phi2* e_par2 
        e_r3 = e_r / np.linalg.norm(e_r)

        mfa_trans = np.row_stack((e_r,e_phi2,e_par2)) #create transformation matrix
    ...
    name = '/Users/aspen.davis/Documents/radiation_belt/mfa_bav_'+date+'.pickle'
    f = open(name,'wb') 
...
#psd_store1 = '/Users/aspen.davis/Documents/GOES/G18/G18_data/L1b_daily/20230226_event/mfa_bav_g18_20230227.pickle'
psd_store1 = '/Users/aspen.davis/Documents/GOES/G16/G16l1b/20230226_event/mfa_bav_g16_20230227.pickle'
file1 = open(psd_store1,'rb')
psd_analysis1 = pickle.load(file1)
b_hp_filt_nT_mfa1 = psd_analysis1['b_hp_filt_nT_mfa'] 


highps_z1_01,f_hp_z1_01, t_hp_z1_01,sgdb_hp_z1_01,psd_avg1_01,Dll1_01,tau_m1_01 = getTau(chunk_1,b_hp_filt_nT_mfa1) 
highps_z2_01,f_hp_z2_01, t_hp_z2_01,sgdb_hp_z2_01,psd_avg2_01,Dll2_01,tau_m2_01 = getTau(chunk_2,b_hp_filt_nT_mfa1) 
highps_z3_01,f_hp_z3_01, t_hp_z3_01,sgdb_hp_z3_01,psd_avg3_01,Dll3_01,tau_m3_01 = getTau(chunk_3,b_hp_filt_nT_mfa1) 
highps_z4_01,f_hp_z4_01, t_hp_z4_01,sgdb_hp_z4_01,psd_avg4_01,Dll4_01,tau_m4_01 = getTau(chunk_4,b_hp_filt_nT_mfa1)
highps_z5_01,f_hp_z5_01, t_hp_z5_01,sgdb_hp_z5_01,psd_avg5_01,Dll5_01,tau_m5_01 = getTau(chunk_5,b_hp_filt_nT_mfa1)
highps_z6_01,f_hp_z6_01, t_hp_z6_01,sgdb_hp_z6_01,psd_avg6_01,Dll6_01,tau_m6_01 = getTau(chunk_6,b_hp_filt_nT_mfa1)
highps_z7_01,f_hp_z7_01, t_hp_z7_01,sgdb_hp_z7_01,psd_avg7_01,Dll7_01,tau_m7_01 = getTau(chunk_7,b_hp_filt_nT_mfa1)
...
date = '20230228'
#psd_store2 = '/Users/aspen.davis/Documents/radiation_belt/20220809/mfa_bav_g17_20220809.pickle'
#psd_store2 = '/Users/aspen.davis/Documents/GOES/G18/G18_data/L1b_daily/20230226_event/mfa_bav_g18_20230228.pickle'
psd_store2 = '/Users/aspen.davis/Documents/GOES/G16/G16l1b/20230226_event/mfa_bav_g16_20230228.pickle'
file2 = open(psd_store2,'rb')
psd_analysis2 = pickle.load(file2)
b_hp_filt_nT_mfa2 = psd_analysis2['b_hp_filt_nT_mfa'] 
highps_z1_02,f_hp_z1_02, t_hp_z1_02,sgdb_hp_z1_02,psd_avg1_02,Dll1_02,tau_m1_02 = getTau(chunk_1,b_hp_filt_nT_mfa2) 
highps_z2_02,f_hp_z2_02, t_hp_z2_02,sgdb_hp_z2_02,psd_avg2_02,Dll2_02,tau_m2_02 = getTau(chunk_2,b_hp_filt_nT_mfa2) 
highps_z3_02,f_hp_z3_02, t_hp_z3_02,sgdb_hp_z3_02,psd_avg3_02,Dll3_02,tau_m3_02 = getTau(chunk_3,b_hp_filt_nT_mfa2) 
highps_z4_02,f_hp_z4_02, t_hp_z4_02,sgdb_hp_z4_02,psd_avg4_02,Dll4_02,tau_m4_02 = getTau(chunk_4,b_hp_filt_nT_mfa2)

highps_z5_02,f_hp_z5_02, t_hp_z5_02,sgdb_hp_z5_02,psd_avg5_02,Dll5_02,tau_m5_02 = getTau(chunk_5,b_hp_filt_nT_mfa2)
highps_z6_02,f_hp_z6_02, t_hp_z6_02,sgdb_hp_z6_02,psd_avg6_02,Dll6_02,tau_m6_02 = getTau(chunk_6,b_hp_filt_nT_mfa2)
highps_z7_02,f_hp_z7_02, t_hp_z7_02,sgdb_hp_z7_02,psd_avg7_02,Dll7_02,tau_m7_02 = getTau(chunk_7,b_hp_filt_nT_mfa2)
highps_z8_02,f_hp_z8_02, t_hp_z8_02,sgdb_hp_z8_02,psd_avg8_02,Dll8_02,tau_m8_02 = getTau(chunk_8,b_hp_filt_nT_mfa2)
...
#psd_store3 = '/Users/aspen.davis/Documents/GOES/G18/G18_data/L1b_daily/20230226_event/mfa_bav_g18_20230301.pickle'
psd_store3 = '/Users/aspen.davis/Documents/GOES/G16/G16l1b/20230226_event/mfa_bav_g16_20230301.pickle'
file3 = open(psd_store3,'rb')
psd_analysis3 = pickle.load(file3)
b_hp_filt_nT_mfa3 = psd_analysis3['b_hp_filt_nT_mfa'] 

highps_z1_03,f_hp_z1_03, t_hp_z1_03,sgdb_hp_z1_03,psd_avg1_03,Dll1_03,tau_m1_03 = getTau(chunk_1,b_hp_filt_nT_mfa3) 
highps_z2_03,f_hp_z2_03, t_hp_z2_03,sgdb_hp_z2_03,psd_avg2_03,Dll2_03,tau_m2_03 = getTau(chunk_2,b_hp_filt_nT_mfa3) 
highps_z3_03,f_hp_z3_03, t_hp_z3_03,sgdb_hp_z3_03,psd_avg3_03,Dll3_03,tau_m3_03 = getTau(chunk_3,b_hp_filt_nT_mfa3) 
highps_z4_03,f_hp_z4_03, t_hp_z4_03,sgdb_hp_z4_03,psd_avg4_03,Dll4_03,tau_m4_03 = getTau(chunk_4,b_hp_filt_nT_mfa3)

highps_z5_03,f_hp_z5_03, t_hp_z5_03,sgdb_hp_z5_03,psd_avg5_03,Dll5_03,tau_m5_03 = getTau(chunk_5,b_hp_filt_nT_mfa3)
highps_z6_03,f_hp_z6_03, t_hp_z6_03,sgdb_hp_z6_03,psd_avg6_03,Dll6_03,tau_m6_03 = getTau(chunk_6,b_hp_filt_nT_mfa3)
highps_z7_03,f_hp_z7_03, t_hp_z7_03,sgdb_hp_z7_03,psd_avg7_03,Dll7_03,tau_m7_03 = getTau(chunk_7,b_hp_filt_nT_mfa3)
...
highps_z_03 = np.concatenate((highps_z1_03, highps_z2_03,highps_z3_03,highps_z4_03,highps_z5_03,highps_z6_03,highps_z7_03,highps_z8_03), axis=None)
#highps_z_04 = np.concatenate((highps_z1_04, highps_z2_04,highps_z3_04,highps_z4_04,highps_z5_04,highps_z6_04,highps_z7_04,highps_z8_04), axis=None)
#highps_z_all = np.concatenate((highps_z_01,highps_z_02,highps_z_03,highps_z_04),axis=None)
...
psd_avg_01 = np.concatenate((psd_avg1_01,psd_avg2_01,psd_avg3_01,psd_avg4_01,psd_avg5_01,psd_avg6_01,psd_avg7_01,psd_avg8_01),axis=None)
psd_avg_02 = np.concatenate((psd_avg1_02,psd_avg2_02,psd_avg3_02,psd_avg4_02,psd_avg5_02,psd_avg6_02,psd_avg7_02,psd_avg8_02),axis=None)
psd_avg_03 = np.concatenate((psd_avg1_03,psd_avg2_03,psd_avg3_03,psd_avg4_03,psd_avg5_03,psd_avg6_03,psd_avg7_03,psd_avg8_03),axis=None)
#psd_avg_04 = np.concatenate((psd_avg1_04,psd_avg2_04,psd_avg3_04,psd_avg4_04,psd_avg5_04,psd_avg6_04,psd_avg7_04,psd_avg8_04),axis=None)
psd_avg_all = np.concatenate((psd_avg_01,psd_avg_02,psd_avg_03),axis=None)

dll_01 = np.concatenate((Dll1_01,Dll2_01,Dll3_01,Dll4_01,Dll5_01,Dll6_01,Dll7_01,Dll8_01),axis=None)
dll_02 = np.concatenate((Dll1_02,Dll2_02,Dll3_02,Dll4_02,Dll5_02,Dll6_02,Dll7_02,Dll8_02),axis=None)
dll_03 = np.concatenate((Dll1_03,Dll2_03,Dll3_03,Dll4_03,Dll5_03,Dll6_03,Dll7_03,Dll8_03),axis=None)
#dll_04 = np.concatenate((Dll1_04,Dll2_04,Dll3_04,Dll4_04,Dll5_04,Dll6_04,Dll7_04,Dll8_04),axis=None)
...
#t1 = nc.Dataset('/Users/aspen.davis/Documents/GOES/G18/G18_data/L1b_daily/20230226_event/dn_magn-l2-hires_g18_d20230227_v1-0-1.nc')
...
#t2 = nc.Dataset('/Users/aspen.davis/Documents/radiation_belt/20220809/dn_magn-l2-hires_g17_d20220809_v1-0-1.nc')
#t2 = nc.Dataset('/Users/aspen.davis/Documents/radiation_belt/data/G16L2/dn_magn-l2-hires_g16_d20220402_v1-0-1.nc')
#t2 = nc.Dataset('/Users/aspen.davis/Documents/GOES/G18/G18_data/L1b_daily/20230226_event/dn_magn-l2-hires_g18_d20230228_v1-0-1.nc')
...
#t3 = nc.Dataset('/Users/aspen.davis/Documents/radiation_belt/20220809/dn_magn-l2-hires_g17_d20220810_v1-0-1.nc')
#t3 = nc.Dataset('/Users/aspen.davis/Documents/radiation_belt/data/G16L2/dn_magn-l2-hires_g16_d20220403_v1-0-1.nc')
#t3 = nc.Dataset('/Users/aspen.davis/Documents/GOES/G18/G18_data/L1b_daily/20230226_event/dn_magn-l2-hires_g18_d20230301_v1-0-1.nc')
t3 = nc.Dataset('/Users/aspen.davis/Documents/GOES/G16/G16l1b/20230226_event/dn_magn-l2-hires_g16_d20230301_v1-0-1.nc')
time_ob_native3 = t3['time']
time_ob_3 = np.asarray(time_ob_native3).flatten()

#t4 = nc.Dataset('/Users/aspen.davis/Documents/GOES/G18/G18_data/L1b_daily/20230226_event/dn_magn-l2-hires_g18_d20230301_v1-0-1.nc')
# t4 = nc.Dataset('/Users/aspen.davis/Documents/GOES/G16/G16l1b/20230226_event/dn_magn-l2-hires_g16_d20230301_v1-0-1.nc')
...
NFFT = 4500#6000
f_hp_zT, t_hp_zT, Sxx_hp_zT = signal.spectrogram(highps_z_all,fs=10, nperseg=int(NFFT),noverlap = int(NFFT / 4))
...
w = 0.001#*2*np.pi#0.01#*2*np.pi#0.01#*2*np.pi #f #azmuthal wave mode frequency, for now using the central wave frequency we settled on above
...
def j2000_sec_to_datetime( unix_ms ):
    dt = np.array( [ dtm.datetime( 2000, 1, 1,12) + dtm.timedelta(seconds=unix_ms[i] ) for i in np.arange( len( unix_ms ) ) ] )
    return( dt )
...
# d = Dataset('/Users/aspen.davis/Documents/radiation_belt/G17/sci_mpsh-l2-avg5m_g17_d20220331_v1-0-3.nc')
...
afluxes=np.reshape(nfluxes,(288*16,5)) #multiply by how many days you are doing :) (288*16,5)
...
# d16 = Dataset('/Users/aspen.davis/Documents/radiation_belt/G16/sci_mpsh-l2-avg5m_g16_d20220331_v1-0-3.nc')
